...
export CONTENT_URL_PREFIX=https://raw.githubusercontent.com/takahiro-ino/keycloak-workshop-guides/quarkus-4.10jp/docs
...
export WORKSHOPS_URLS=https://raw.githubusercontent.com/takahiro-ino/keycloak-workshop-guides/quarkus-4.10jp/docs/_sso-workshop-guides.yml
